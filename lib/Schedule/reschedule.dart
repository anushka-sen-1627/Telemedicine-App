...
import 'package:chat/Schedule/popup2.dart';
...
class ReScheduleForm extends StatelessWidget {
  const ReScheduleForm({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Rescheduling....'),
    );
  }
}
  ...
  Future<void> _showMyDialog() async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Clinic Re-Scheduling Form'),
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => Pop2()),
                );
              },
              child: Text('Confirm'),
            ),
